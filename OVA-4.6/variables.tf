...
variable "nodes" {
  ...
  description = "ignition in base64, in case of using isos the ignition content is not needed, ipstring is the value for vm property guestinfo.afterburn.initrd.network-kargs"
}